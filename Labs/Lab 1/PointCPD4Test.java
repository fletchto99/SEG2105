/*Based upon the class PointCPTest.java provided for this Laboratory
*
...
public class PointCPD4Test
{
    ...
    /**
     * This method is responsible for the creation of the PointCPD4
     * object.  This can be done in two ways; the first, by using the
     * command line and running the program using <code> java
     * PointCPD4Test &lt;coordtype (c/p)&gt; &lt;X/RHO&gt; &lt;Y/THETA&gt;
    ...
    public static void main(String[] args)
    {
        ...
        // If he did, create the PointCPD4 object from these arguments.
        // If he did not, prompt the user for them.
        try
        {
            point = new PointCPD4(args[0].toUpperCase().charAt(0),
     ...
     * it is valid.  When the input is valid, it returns a PointCPD4
     * object.
     *
     * @return A PointCPD4 constructed using information obtained
     *         from the user.
